...
import { AlertTriangle, ClipboardList, Inbox, Leaf, LogOut, Settings, Sparkles, User } from "lucide-react";
...
import { VendorOfferInbox } from "./components/VendorOfferInbox";
...
const SIDEBAR = {
  ...
  nav: [
    ...
    { label: "Offers", to: "/dashboard/vendor?tab=offers", icon: <Inbox className="h-4 w-4" /> },
        ...
        {isPendingVerification && (
          ...
          >
            ...
            <Link
              ...
              className="shrink-0 rounded-xl bg-amber-500 px-3 py-2 text-xs font-bold text-white hover:bg-amber-600 transition-colors"
            >
              View status
            </Link>
          </motion.div>

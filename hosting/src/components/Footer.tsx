        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1">
            <Link to="/" className="inline-block mb-5">
              <img src="/logo.png" alt="Foodie Market" className="h-9 w-auto brightness-0 invert" />
            </Link>
            ...
            <div className="flex gap-3">
              {[Facebook, Twitter, Instagram, Youtube].map((Icon, i) => (
                <span key={i} className="flex h-9 w-9 items-center justify-center rounded-xl bg-gray-800 text-gray-400 hover:bg-orange-500 hover:text-white transition-all cursor-not-allowed opacity-60" title="Coming soon">
